...
module.exports = client => {
  ...
  client.on("guildMemberRemove", async member => {
    ...
    if (leftInviterData) {
      ...
      invitemessage = `Was Invited by ${invitedby && invitedby.tag ? `**${invitedby.tag}**` : `<@${leftInviterData.id}>`}\n<:Like:1007623270872383508> **${realinvites} Invite${realinvites == 1 ? "" : "s"}**\n[<:Join_vc:1007623581741629469> ${invites} Joins | <:leaves:1007437059499237426> ${leaves} Leaves | <:no:1007436622733774911> ${fake} Fakes]`;
    } else {

...
module.exports = (client) => {
  ...
  client.on("messageCreate", async (message) => {
    ...
    client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<a:yes_animated:1007611220842528799> Accepted Idea! Expect this soon.`,
          denymsg: `<:no:1007436622733774911> Thank you for the feedback, but we are not interested in this idea at this time.`,
          maybemsg: `💡 We are thinking about this idea!`,
          duplicatemsg: `💢 This is a duplicated Suggestion`,
          soonmsg: `👌 Expect this Feature Soon!`,
          statustext: `<a:Loading:1007611463294275634> Waiting for Community Feedback, please vote!`,
